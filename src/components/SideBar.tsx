...
// Функция компонента бокового меню навигации
export default function SideBar({ isSidebarOpened, setIsSidebarOpened}: IProps) {
  return (
    <div
      className={`fixed top-0 left-0 z-80 h-full w-[70vw] bg-black ease-in-out duration-300 ${
        ...
        <div className="w-[20px] h-[15px] ml-[20px] mt-[30px] mb-5">
            <img className="h-full w-full hover:cursor-pointer" onClick={() => { setIsSidebarOpened(false); }} src={menu} alt="menu" />
        </div>
      <div>
