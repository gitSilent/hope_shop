        ...
        <div className='relative min-h-[100%] pb-[150px]'>
            ...
            <section className='relative  min-h-[278px] md:min-h-[188px] mt-[40px] md:pb-[160px] md:mt-[120px]'>
                <div className='absolute z-[-1] h-[278px] w-full'>
                    ...
                    <img src={about_bgMobile} alt="" className='md:hidden z-0 absolute top-0 left-0 w-full h-full object-cover' />
                </div>
                <img src={about_bg} alt="" className='hidden w-full h-full object-cover z-[-1] absolute md:block' />
            ...
            <section className='mt-[40px] mb-[50px]'>
                ...
                <div className='mt-[20px]'>
                    <YMaps>
                        <div>
                            <Map defaultState={{ center: [54.564736, 36.263641], zoom: 17 }} width={"100%"} height={`${window.innerWidth >= 768 ? '500px' : '270px'}`}>
                ...
                <div className='flex justify-center mt-[50px] px-[20px] md:gap-[95px]'>
                    <div className='flex flex-col max-w-[164px] md:gap-[95px] md:flex-row md:max-w-[1220px]'>
                        <div className=''>
                            ...
                            <p className='text-[16px] text-[#2b2b2b] font-medium'>1-я Загородная улица, д. 2</p>
                        </div>
